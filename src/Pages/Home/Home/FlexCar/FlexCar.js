...
const FlexCar = () => {
    return (
        <div className="hero h-[323px] bg-primary rounded-md mt-[150px]">
            <div className="hero-content flex-col lg:flex-row gap-96 mr-[200px]">
                <h1 className="text-5xl font-bold text-white leading-normal">Ready to launch  <br />your next website?</h1>
